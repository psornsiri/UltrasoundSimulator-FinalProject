...
{
	public class SetPlaneEvalPredRot : MonoBehaviour
	{	
		List<string> rows = new List<string>();
		Vector3 pose_vect;
		private int waitForMilliSeconds = 2000;
		...
		{
		    //read in data file
		    StreamReader reader = new StreamReader("Assets/Tests/rotation/3_coords/evaluation/predicted_eul_eval.csv");
